...
% *the backbone optimizer: surrogate-assisted optimization algorithm*
%
% ------------
% Reference:
% ------------
...
specifications = [1 1 1 50 k; % STOP 1
    ...
    5 1 8 50 k; % STOP 11
    2 2 7 50 k]; % STOP 12
backbone_opt = 'saea_source'; % saea_source: BO-LCB
FEsMax = 500; % the maximum function evaluations

function ada_vectors = task_adaptation(surrogates_source,solutions_target,objs_target,FEsAdaMax)
...
for i = 1:num_sources
    ...
    [~,~,ada_vectors(i,:)] = evolutionary_search(func_ada,lb_ada,ub_ada,FEsAdaMax,paras);
    fprintf('The adaptation phase of SAES-CKT (%d out of %d)\n',i,num_sources);
end
